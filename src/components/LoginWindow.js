        ...
        return (
            <div className="login-window">
                ...
                <div className="form-group">
                    <label htmlFor="nick" className="col-sm-3">Nick</label>
                ...
                <div className="form-group">
                    <label htmlFor="server" className="col-sm-3">Server</label>
                    <div className={'col-sm-8'}>
                ...
                <div className="form-group">
                    <label htmlFor="port" className="col-sm-3">Port</label>
                    <div className={'col-sm-8'}>
                ...
                <div>
                    <Button className="login-btn" onClick={::this.onLogin}>Connect</Button>
                </div>         
            </div>
        );
    }
